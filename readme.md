...
``` bash
go get github.com/maurodelazeri/bitfinex-api-go
```
...
import (
	"fmt"
	"github.com/maurodelazeri/bitfinex-api-go/v1"
)
...
See [examples](https://github.com/maurodelazeri/bitfinex-api-go/tree/master/examples) and [doc.go](https://github.com/maurodelazeri/bitfinex-api-go/blob/master/doc.go) for more examples.
...
1. Fork it (https://github.com/maurodelazeri/bitfinex-api-go/fork)
